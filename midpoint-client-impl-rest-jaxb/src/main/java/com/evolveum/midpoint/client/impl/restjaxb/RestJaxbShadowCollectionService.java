...
public class RestJaxbShadowCollectionService extends RestJaxbObjectCollectionService<ShadowType> implements ShadowCollectionService {
	...
	public RestJaxbShadowCollectionService(final RestJaxbService service) {
		super(service, Types.SHADOWS.getRestPath(), ShadowType.class);
	}

	@Override
	public ShadowService oid(String oid) {
		return new RestJaxbShadowService(getService(), oid);
	}
}
